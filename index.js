...
console.log("\n", chalk.white.bold.bgGreenBright("The desired number lies between 1 and 100. You have three turns. Press any key to start"), "\n");
(async function runGame() {
    ...
    do {
        ...
        if (number === numbertoG) {
            console.log(chalk.blueBright("Bingo, You got it right. The Number I had in mind was", numbertoG));
            turn = 3;
        }
        ...
        if (number !== numbertoG && turn > 2) {
            console.log(chalk.redBright("Better Luck Next Time. The Number I had in mind was", numbertoG));
        }
    } while (turn <= 2);
})();
